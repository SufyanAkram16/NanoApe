...
export default function Navbar() {
  return (
    <>   
        <nav className='font-Poppins text-[18px] text-white rounded-b-3xl'>
          <div className='conatiner m-auto px-3 p-5'>
            ...
            <div><a href='https://pancakeswap.finance/swap?chain=bsc&outputCurrency=0x2D09f330DFfd40FC1B49F0b6Deb5fA1C3f763226' className='cursor-pointer flex items-center justify-center border border-white bg-[#FFB800] text-white md:p-4 p-3 rounded-xl shadow-2xl hover:bg-yellow-600 transition-all duration-300 ease-in-out hover:border hover:border-black hover:text-black'>Nano Ape<svg  xmlns="http://www.w3.org/2000/svg " width="16" height="16" fill="currentColor" className="bi bi-cart w-4 h-4 md:w-6 md:h-6 ml-1" viewBox="0 0 16 16"> <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" /> </svg></a></div>
            </div>
          </div>
        </nav>
    </>
